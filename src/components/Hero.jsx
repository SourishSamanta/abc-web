    ...
    return (
        ...
        <div className=" h-[90vh] w-full flex items-end justify-center overflow-hidden z-10">
            ...
            <div className="flex flex-col items-center justify-end  mb-12">
                ...
                <h1 className=" text-[3vw] font-bold mb-2 overflow-hidden">
                ...
                <button className=" border-white border-2 bg-white/20 px-14 py-3 rounded-3xl mt-8 hover:bg-white text-[1.3vw] font-bold hover:text-black transition-all duration-200 flex items-center gap-2">
